...
public class C3P0 extends GadgetChain<NoTrampoline> {

    public C3P0() {
        super(NoTrampoline.getInstance());
    }

    public C3P0(NoTrampoline _trampoline) {
        super(_trampoline);
    }
    ...
    protected String getStackTrace() {
        return "com.mchange.v2.c3p0.impl.PoolBackedDataSourceBase.readObject()\n" +
